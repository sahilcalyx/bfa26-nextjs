...
<div
          ...
          <div className="cs-section_heading cs-style2 cs-size3 text-center text-uppercase">
            ...
            <div className=" cs-primary_font cs-medium cs-accent_color">
              ...
              >
                ...
                <NavLink to="/networking-gallery-2024" className="font-gallery active-gallery">
                  Networking
                </NavLink>
        ...
        >
          <div className="cs-isotop row cs-style1 cs-isotop_col_3 cs-has_gutter_30 cs-lightgallery">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/2.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/2.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/3.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/3.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/4.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/4.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/5.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/5.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/6.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/6.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/7.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/7.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/8.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/8.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/9.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/9.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/10.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/10.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/11.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/11.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/12.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/12.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/13.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/13.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/14.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/14.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/24.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/24.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/16.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/16.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/17.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/17.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/18.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/18.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/19.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/19.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/20.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/20.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/21.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/21.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/22.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/22.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/23.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/23.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/networking/25.jpg"
                   className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
          
                data-sub-html="<h4>Networking</h4>"
              >
                 <img
                src="../assets/img/gallery/networking/25.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
...
export default NetworkingGallery;

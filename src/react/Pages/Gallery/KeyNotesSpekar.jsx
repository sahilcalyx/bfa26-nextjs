...
<div
          ...
          <div className="cs-section_heading cs-style2 cs-size3 text-center text-uppercase">
            ...
            <div className=" cs-primary_font cs-medium cs-accent_color">
              ...
              >
                ...
                <NavLink to="/key-notes-gallery-2024" className="font-gallery active-gallery">
                  Key Note Speakers
                </NavLink>
        ...
        >
          <div className="cs-isotop row cs-style1 cs-isotop_col_3 cs-has_gutter_30 cs-lightgallery">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/key-note/2.jpg"
             className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
             
                data-sub-html="<h4>Key Note Speakers</h4>"
              >
                           <img
                src="../assets/img/gallery/key-note/2.jpg"
                alt="Key Note Speakers"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/key-note/3.jpg"
             className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
             
                data-sub-html="<h4>Key Note Speakers</h4>"
              >
                           <img
                src="../assets/img/gallery/key-note/3.jpg"
                alt="Key Note Speakers"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/key-note/4.jpg"
             className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
             
                data-sub-html="<h4>Key Note Speakers</h4>"
              >
                           <img
                src="../assets/img/gallery/key-note/4.jpg"
                alt="Key Note Speakers"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/key-note/5.jpg"
             className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
             
                data-sub-html="<h4>Key Note Speakers</h4>"
              >
                           <img
                src="../assets/img/gallery/key-note/5.jpg"
                alt="Key Note Speakers"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">

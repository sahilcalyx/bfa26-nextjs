          ...
          <div className="cs-section_heading cs-style2 cs-size3 text-center text-uppercase">
            ...
            <div className=" cs-primary_font cs-medium cs-accent_color">
              ...
              >
                ...
                <NavLink to="/dinner-2024" className="font-gallery active-gallery">
                  Dinner
                </NavLink>
              </div>
            </div>
        ...
        >
          <div className="cs-isotop row cs-style1 cs-isotop_col_3 cs-has_gutter_30 cs-lightgallery">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/dinner/1.jpg"
               className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
             
                data-sub-html="<h4>Dinner</h4>"
              >
                    <img
                src="../assets/img/gallery/dinner/1.jpg"
                alt="Networking"
                className="img-fluid"
              />
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/dinner/2.jpg"
               className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
             
                data-sub-html="<h4>Dinner</h4>"
              >
                    <img
                src="../assets/img/gallery/dinner/2.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/dinner/3.jpg"
               className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
             
                data-sub-html="<h4>Dinner</h4>"
              >
                    <img
                src="../assets/img/gallery/dinner/3.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/dinner/4.jpg"
               className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
             
                data-sub-html="<h4>Dinner</h4>"
              >
                    <img
                src="../assets/img/gallery/dinner/4.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">
            ...
            <div className="cs-isotop_item">
              <a
                href="../assets/img/gallery/dinner/5.jpg"
               className="cs-gallery cs-style1 cs-bg cs-gallery_height6 cs-lightbox-item"
             
                data-sub-html="<h4>Dinner</h4>"
              >
                    <img
                src="../assets/img/gallery/dinner/5.jpg"
                alt="Networking"
                className="img-fluid"
              />
                <div className="cs-gallery_hover cs-center cs-accent_80_bg">

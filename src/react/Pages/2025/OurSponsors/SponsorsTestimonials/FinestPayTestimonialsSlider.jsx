...
const FinestPayTestimonialsSlider = () => {
  const sliderRef = useRef(null);

  const testimonials = [
    {
      id: 1,
      text: `FinestPay successfully transferred funds to our African receiptients within minutes. They were literal life savers on this occassion.`,
      name: 'Bukola Coker',
      designation: '- Tala Harmony Inc.',
     
    },
    {
      id: 2,
      text: ` The difference between the cost of foreign currency from the banks and from FinestPay is unbelievable. FinestPay saved me and my business money and time, again and again.`,
      name: 'Charles Nwaodu',
      designation: '- CN-Investments Ltd.',
    
    },
    
    {
    id: 3,
      text: ` I have used FinestPay on many occasions for funds transfer. I cannot speak highly enough of the service I received - courteous, professional and stress free service from FinestPay. The exchange rate has always been very good. I recommend FinestPay to my business associates and look forward to doing more business in the future.`,
      name: 'Ngozi Eze',
      designation: '- Yandel Ng.',
...
export default FinestPayTestimonialsSlider;

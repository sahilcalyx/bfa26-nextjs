...
const BelyftedTestimonialsSlider = () => {
  const sliderRef = useRef(null);

  const testimonials = [
    {
      id: 1,
      text: `With Belyfted, sending money is fast, secure, and hassle-free. Great rates and seamless transactions!`,
      name: 'Alex Rivera',
      designation: '@jamietechguru00',
     
    },
    {
      id: 2,
      text: `Belyfted makes money transfers easy, fast, and secure with great exchange rates!`,
      name: 'Casey Jordan',
      designation: '@caseyj',
    ...
    {
    id: 3,
      text: `Belyfted offers fast, secure, and reliable money transfers with great exchange rates and a seamless experience!`,
      name: 'Jordan Patelse',
      designation: '@jpatelsdesign',
   
    },
    {
     id: 4,
      text: `Belyfted makes money transfers simple, fast, and secure every time!`,
      name: 'Josh Smith',
      designation: '@jjsmith',
    ...
    {
     id: 5,
      text: `Belyfted is the best choice for fast, secure, and hassle-free money transfers. Great rates, easy transactions, and a seamless experience every time!`,
      name: 'Sam Dawson',
      designation: '@dawsontechtips',
...
export default BelyftedTestimonialsSlider;
